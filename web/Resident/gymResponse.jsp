	...
	if(isValideChecksum && parameters.containsKey("RESPCODE")){
		if(parameters.get("RESPCODE").equals("01")){
                        try{
                            ...
                            int a=s.executeUpdate("UPDATE `gym_swimming` SET `status`=true WHERE o_id='"+orderid+"'");
			...
			outputHTML="<b>Payment Failed.</b><a href=GymMember.jsp>Click here to try again</a>";
		}
	}else{
		outputHTML="<b>Checksum mismatched.</b><a href=GymMember.jsp>Click here to try again</a>";
	}
}catch(Exception e){
