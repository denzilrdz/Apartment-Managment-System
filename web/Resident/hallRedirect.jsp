...
parameters.put("CALLBACK_URL", "http://localhost:8080/Apartment_Managment_System/Resident/hallResponse.jsp");
String checkSum =  CheckSumServiceHelper.getCheckSumServiceHelper().genrateCheckSum(DBCon.paytmKEY, parameters);
