<%--
    Document   : ViewAllLog
    Created on : 18 Feb, 2020, 6:45:06 PM
    ...
    <body>
        ...
        <div class="col-sm-8 col-md-6 mt-2 ">
            <table class="table table-striped text-white" style="text-align:center;">
                ...
                <tbody>
                    <%
                            ResultSet rs = s.executeQuery("SELECT f.regno, f.name, f.date, e.exit_time FROM entry_log f,exit_log e WHERE f.regno=e.regno");
                            while (rs.next()) {
                                out.print("<tr><td>" + rs.getInt(1) + "</td><td>" + rs.getString(2) + "</td><td>" + rs.getString(3) + "</td><td>" + rs.getString(4) + "</td></tr></tbody></div>");
                            }
                            out.print("</table>");
                            s.close();
                            con.close();
